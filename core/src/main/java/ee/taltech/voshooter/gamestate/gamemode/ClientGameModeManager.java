...
public class ClientGameModeManager {
    ...
    private BitmapFont font = new BitmapFont(Gdx.files.internal("bitmapFont/commodore.fnt"),
                Gdx.files.internal("bitmapFont/commodore.png"), false);

    public ClientGameModeManager(int gameMode, OrthographicCamera camera, MainScreen screen, SpriteBatch batch) {
